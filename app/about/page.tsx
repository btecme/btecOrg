            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-12 text-lg text-foreground/80 leading-relaxed">
                    <section>
                        ...
                        <p className="mt-6">
                            b-tec also supports organizations that have outgrown informal technology management, helping leadership stabilize infrastructure, modernize cloud and endpoint operations, improve vendor accountability, and prepare systems for practical automation and digital intelligence.
                        </p>
                    </section>
