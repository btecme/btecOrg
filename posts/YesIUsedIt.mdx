...
I want to tell you the feeling it produces is anger. That would make for a better essay. But the truth is duller and more depressing than that. It's exhaustion. The bone-deep kind. The kind that comes from watching someone you respect ask a question so reductive, so fundamentally unserious, that you can't figure out where to even start addressing it.

So you just say "yeah, I wrote it" and move on and feel a little gross about the whole exchange.

I've been in IT for a long time. Decades of tools that were going to "ruin everything". I am tired in a way that coffee doesn't fix.
...
Here's a question nobody has ever asked you about good writting: "Did you use spell check on that?"
...
So what did you write? Did you write the version before Grammarly touched it? Did Grammarly write the parts it suggested? Did you write the final version because you clicked "accept"? Does clicking "accept" count as writing? Does clicking "ignore" count more? Did you use Google Maps to get here? Did you use a hammer to build that house? 'Do you think that's air you're breathing?' (sorry, i digress)

Nobody asks these questions. Nobody has ever asked these questions (except maybe an actor or two). Because when the tool is familiar, when you've had enough time to absorb it into your workflow, the question sounds as stupid out loud as it always was.
...
* (yes i saw the double tt near the top.)
